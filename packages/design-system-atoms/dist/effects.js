...
exports.useLocationEffect = exports.useFontWeightEffect = exports.useFlexEffect = exports.useTagEffect = exports.useFontSizeEffect = exports.useStylesEffect = exports.useGradientEffect = exports.useBoxBaseStyleEffect = void 0;
...
var useBoxBaseStyleEffect = props => {
  ...
  (0, _react.useEffect)(() => {
    ...
    if (props.variants && props.variants.includes('card')) {
      ...
      if (props.effects) {
        ...
        if (props.effects.includes('blue')) Object.assign(tag, {
          bg: 'blue',
          border: '1px solid #e0e0e0',
          color: '#FFF'
        });
...
exports.useBoxBaseStyleEffect = useBoxBaseStyleEffect;

var useGradientEffect = props => {
  var theme = (0, _react.useContext)(_core.ThemeContext);
  var [gradient, setGradient] = (0, _react.useState)();
  (0, _react.useEffect)(() => {
    if (props.gradient) setGradient("linear-gradient(180deg , ".concat((0, _idx.default)(theme, _ => _.gradients[props.gradient]), ")"));
  }, [props.gradient]);
  return gradient;
};
/**
...
var useLocationEffect = props => {
  ...
  (0, _react.useEffect)(() => {
    ...
    if (props.fillContainer) setStyled({
      bottom: 0,
      top: 0,
      left: 0,
      right: 0,
